...
namespace SenseNet.DirectoryServices
{
    public sealed class SyncTree : IDisposable
    {
        ...
        {
            // objectADPath e.g.: LDAP://192.168.0.75/OU=MyOrg,OU=OtherOrg,OU=ExampleOrg,DC=Nativ,DC=local
        ...
        {
            // objectPortalPath e.g.: /Root/IMS/NATIV/ExampleOrg
