...
namespace SenseNet.DirectoryServices
{
    public static class Common
    {
        ...
        {
            return ContentQuery.Query("SyncGuid:@0", null, guid.ToString()).Nodes.FirstOrDefault();
        }
        ...
        {
            // ADDomainPath e.g.: DC=Nativ,DC=local
        ...
        public static string StripADName(string name)
        {
            ...
            // leading and trailing whitespaces and trailing '.' is trimmed
        ...
        {
            return string.Concat(DateTime.UtcNow.ToString("yyMMddHHmm"), "_", s);
        }
    }
}
