...
To finalize the installation and get started with sensenet SyncPortal2AD, please follow these steps:
...
2. Install sensenet Sync Portal to AD using SnAdmin

   - open a command line and go to the \Admin\bin folder
   - execute the install-syncportal2ad command with the SnAdmin tool
